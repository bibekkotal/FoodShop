    	...
    	?>
         <div class="col-md-6">
          	...
          	<div class="card shadow">
				<div class="row">
				<div class="col-md-6">
				<img src="product_img/<?php echo $row['f_image']; ?>" alt="Product Image" class="img-fluid">
				</div>
				<div class="col-md-6">
					  <div class="card-body">
						...
						<p class="card-subtitle">&#8226 enjoy a taste of heaven<br>&#8226 satisfy your taste<br>&#8226 made to perfection</p></div>
					    	<p id="card-price">&#8212 &#8377; <?php echo $row['f_price']; ?>/-</p>
						       ...
						       <div class="row qtb">
						       		<div class="col-md-2"><input type="number" name="qty" value="1" min="1" id="qnty"></div>
